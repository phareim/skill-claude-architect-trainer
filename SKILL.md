---
name: claude-quiz
description: Use ONLY on explicit quiz/exam intent — the user types `/claude-quiz`, `claude-quiz`, or says something like "quiz me", "test me on Claude", "prep me for the Architect exam", "give me a practice question", or asks how their current work relates to the certification material. Runs an interactive Socratic quiz keyed to the Claude Certified Architect — Foundations exam: one scenario-style question at a time, then coaches the user toward the right reasoning, ties the answer back to whatever they're currently building, and logs every Q&A into a SQLite database for progress tracking. Do NOT trigger on ordinary correctness questions mid-task ("am I doing this right?", "is this the recommended way?") — answer those directly; quiz mode is opt-in.
---
